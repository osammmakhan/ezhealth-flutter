...
class _PatientAppointmentScreenState extends State<PatientAppointmentScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize with first date and time slot after the widget is built
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<AppointmentProvider>(context, listen: false);
      final firstDate = _generateWeekDays().first;
      final firstTimeSlot = _generateTimeSlots().first;

      provider.setSelectedDate(firstDate);
      provider.setSelectedTime(firstTimeSlot);
    });
  }
            ...
            Align(
              ...
              child: Padding(
                ...
                child: HorizontalBtn(
                  ...
                  onPressed: () {
                    // appointmentProvider.hasActiveAppointment = true;
                  },
                ),
              ),
            ),
